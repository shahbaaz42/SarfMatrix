...
(function exposeLocalization(globalScope) {
  ...
  const messages = {
    ...
    "ui.explanation.title": "Rules & Explanation",
    "ui.explanation.intro": "Choose any generated form to see its structure, transformations, accepted alternatives and linked source evidence.",
    "ui.control.section": "Section",
    "ui.control.form": "Form",
    "ui.control.row": "Pronoun / row",
    "ui.control.value": "Derived value",
    "ui.section.section01": "Section 01 — Indicative & passive",
    "ui.section.section02": "Section 02 — Jussive, subjunctive & emphasis",
    "ui.section.section03": "Section 03 — Commands",
    "ui.section.section04": "Section 04 — Derived forms",
    "ui.form.past": "Active past",
    "ui.form.present": "Active present",
    "ui.form.passivePast": "Passive past",
    "ui.form.passivePresent": "Passive present",
    "ui.form.majzumPresent": "Jussive present",
    "ui.form.mansubPresent": "Subjunctive present",
    "ui.form.heavyEmphatic": "Heavy emphasis",
    "ui.form.lightEmphatic": "Light emphasis",
    "ui.form.imperative": "Command / request",
    "ui.form.heavyImperative": "Heavy emphatic command",
    "ui.form.lightImperative": "Light emphatic command",
    "ui.group.masdar": "Maṣdar",
    "ui.group.activeParticiple": "Active participle",
    "ui.group.passiveParticiple": "Passive participle",
    "ui.group.elative": "Elative",
    "ui.group.zarf": "Noun of time/place",
    "ui.row.fallback": "Row {number}",
    "ui.value.fallback": "Form {number}",
    "ui.block.structure": "Structure",
    "ui.block.rules": "Rules",
    "ui.block.derivation": "Derivation",
    "ui.block.alternatives": "Accepted alternatives",
    "ui.block.sources": "Sources",
    "ui.empty.structure": "No structural segments are available for this target.",
    "ui.empty.rules": "No special transformation rule is needed for this selected form.",
    "ui.empty.derivation": "No transformation stages are recorded for this selected form.",
    "ui.empty.alternatives": "No alternative forms are recorded for this target.",
    "ui.empty.sources": "No source reference is attached to the selected rule record.",
    "ui.derivation.underlying": "Underlying form",
    "ui.error.render": "The explanation for this form could not be displayed.",
  };
