...
(function exposeDerivationalComponents(globalScope) {
  ...
  // Older Mazīd templates intentionally predate stable elementIds. Their identity
  // is therefore assigned by explicit Bāb + generated field + derivational ordinal.
  const LEGACY_ROLE_SEQUENCES = Object.freeze({
    "form-iv-ifal": Object.freeze({
      past: [["hamza-of-ifal"]], passivePast: [["hamza-of-ifal"]], imperative: [["hamza-of-ifal"]],
      heavyImperative: [["hamza-of-ifal"]], lightImperative: [["hamza-of-ifal"]],
      masdar: [["hamza-of-ifal"], ["form4-masdar-alif"]],
      activeParticiple: [["participle-mim"]], passiveParticiple: [["participle-mim"]],
    }),
    "form-ii-tafil": Object.freeze({
      masdar: [["form2-masdar-ta"], ["form2-masdar-ya"]],
      activeParticiple: [["participle-mim"]], passiveParticiple: [["participle-mim"]],
    }),
    "form-iii-mufaalah": Object.freeze({
      ...
      majzumPresent: [["form3-alif"]], mansubPresent: [["form3-alif"]], heavyEmphatic: [["form3-alif"]], lightEmphatic: [["form3-alif"]],
      imperative: [["form3-alif"]], heavyImperative: [["form3-alif"]], lightImperative: [["form3-alif"]],
      masdar: [["masdar-mim"], ["form3-alif"], ["masdar-ta-marbuta"]],
      activeParticiple: [["participle-mim"], ["form3-alif"]], passiveParticiple: [["participle-mim"], ["form3-alif"]],
    }),
    "form-v-tafaul": Object.freeze({
      past: [["form5-ta"]], present: [["form5-ta"]], passivePast: [["form5-ta"]], passivePresent: [["form5-ta"]],
      majzumPresent: [["form5-ta"]], mansubPresent: [["form5-ta"]], heavyEmphatic: [["form5-ta"]], lightEmphatic: [["form5-ta"]],
      imperative: [["form5-ta"]], heavyImperative: [["form5-ta"]], lightImperative: [["form5-ta"]],
    ...
    "form-vi-tafaul": Object.freeze({
      past: [["form6-ta"], ["form6-alif"]], present: [["form6-ta"], ["form6-alif"]], passivePast: [["form6-ta"], ["form6-alif"]], passivePresent: [["form6-ta"], ["form6-alif"]],
      majzumPresent: [["form6-ta"], ["form6-alif"]], mansubPresent: [["form6-ta"], ["form6-alif"]], heavyEmphatic: [["form6-ta"], ["form6-alif"]], lightEmphatic: [["form6-ta"], ["form6-alif"]],
      imperative: [["form6-ta"], ["form6-alif"]], heavyImperative: [["form6-ta"], ["form6-alif"]], lightImperative: [["form6-ta"], ["form6-alif"]],
  ...
  function enrichPresentation(presentation, { bab, field }) {
    ...
    const runs = presentation.runs.map((run) => {
      ...
      if (!addition && (run.kind === "derivational" || run.kind === "derivational-copy")) {
        const roles = legacy[derivationalOrdinal];
        if (roles) addition = {
          morphologicalRoles: roles,
          orthographicRoles: roles.some((role) => role === "hamza-of-ifal") ? ["hamzat-qat"] : [],
        };
      }
    ...
    return rows.map((row) => {
      ...
      if (copy.presentation) {
        for (const [field, presentation] of Object.entries(copy.presentation)) {
          copy.presentation[field] = enrichPresentation(presentation, { bab, field });
        }
      }
  ...
  function enrichSection04(section04, bab) {
    ...
    for (const rows of Object.values(copy)) {
      ...
      for (const row of rows) {
        if (Array.isArray(row.presentations)) {
          row.presentations = row.presentations.map((presentation) => enrichPresentation(presentation, { bab, field: row.label === "المصدر" ? "masdar" : "activeParticiple" }));
        }
      }
    }
    return deepFreeze(copy);
  ...
  function enrichDerivationalSnapshot(snapshot) {
    ...
    for (const section of ["section01", "section02", "section03"]) {
      if (Array.isArray(copy.sections[section])) copy.sections[section] = enrichRows(copy.sections[section], copy.bab);
    }
