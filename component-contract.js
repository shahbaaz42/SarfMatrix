...
(function exposeComponentContract(globalScope) {
  ...
  const MORPHOLOGICAL_ROLE_IDS = Object.freeze([
    ...
    "hamza-of-ifawlal", "hamza-of-ifawwal", "hamza-of-ifanlal", "hamza-of-ifanla",
    "hamza-of-quadriliteral-ifanlal", "hamza-of-quadriliteral-ifalalla",

    // Bāb-specific derivational material.
    "form2-masdar-ta", "form2-masdar-ya",
    "form3-alif", "form3-passive-waw",
    "form4-masdar-alif",
    "form5-ta",
    "form6-ta", "form6-alif", "form6-passive-waw",
    "form7-nun",
    "form8-ta",
    "form9-r3-copy",
    "form10-sin", "form10-ta",
    "form11-pattern-alif", "form11-r3-copy", "form11-masdar-ya",
    "form12-waw", "form12-r2-copy", "form12-masdar-ya",
    "form13-waw-geminate",
    "form14-inserted-nun", "form14-r3-copy",
    "form15-inserted-nun", "form15-final-ya",
    "quadriliteral-tafaul-ta",
    "quadriliteral-ifanlal-inserted-nun",
    "quadriliteral-ifalalla-r4-copy",

    // Shared derived-form material.
    "masdar-alif", "masdar-mim", "masdar-ta-marbuta", "participle-mim",
  ]);

  const ORTHOGRAPHIC_ROLE_IDS = Object.freeze(["hamzat-wasl", "hamzat-qat"]);
  ...
  function withComponentIdentity(run, identityInput = {}) {
    ...
    return deepFreeze({ ...clone(run), morphologicalRoles: identity.morphologicalRoles, orthographicRoles: identity.orthographicRoles });
  }
  ...
  const api = deepFreeze({
    COMPONENT_IDENTITY_SCHEMA_VERSION, STRUCTURAL_KINDS, MORPHOLOGICAL_ROLE_IDS, ORTHOGRAPHIC_ROLE_IDS,
    createComponentIdentity, validateComponentIdentity, withComponentIdentity, validateStructuralRunIdentity,
  });
